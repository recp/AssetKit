...
TEST_DECLARE(scene_find_or_make_root_uses_node_refs)
TEST_DECLARE(dae_scene_roots_are_refs)
TEST_DECLARE(dae_instance_node_is_node_ref)
TEST_DECLARE(obj_scene_root_is_ref)
...
TEST_LIST {
  ...
  TEST_ENTRY(scene_find_or_make_root_uses_node_refs)
  TEST_ENTRY(dae_scene_roots_are_refs)
  TEST_ENTRY(dae_instance_node_is_node_ref)
  TEST_ENTRY(obj_scene_root_is_ref)
