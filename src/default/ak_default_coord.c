...
/* Right Hand (Default) */
AkCoordSys AK__Y_RH_VAL =              {AK__Y_RH, AK_AXIS_ROT_DIRECTION_RH};
AkCoordSys * AK_YUP     = &AK__Y_RH_VAL;
AkCoordSys * AK_ZUP     = &(AkCoordSys){AK__Z_RH, AK_AXIS_ROT_DIRECTION_RH};
AkCoordSys * AK_XUP     = &(AkCoordSys){AK__X_RH, AK_AXIS_ROT_DIRECTION_RH};

/* Left Hand */
AkCoordSys * AK_ZUP_LH = &(AkCoordSys){AK__Z_LH, AK_AXIS_ROT_DIRECTION_LH};
AkCoordSys * AK_YUP_LH = &(AkCoordSys){AK__Y_LH, AK_AXIS_ROT_DIRECTION_LH};
AkCoordSys * AK_XUP_LH = &(AkCoordSys){AK__X_LH, AK_AXIS_ROT_DIRECTION_LH};
