...
typedef enum AkValueType {
  ...
  AK_VALUE_FLOAT3        = 11,
  AK_VALUE_FLOAT4        = 12,
  AK_VALUE_FLOAT2x2      = 13,
  AK_VALUE_FLOAT3x3      = 14,
  AK_VALUE_FLOAT4x4      = 15,
  AK_VALUE_STRING        = 16,

  AK_VALUE_SAMPLER1D     = 17,
  AK_VALUE_SAMPLER2D     = 18,
  AK_VALUE_SAMPLER3D     = 19,
  AK_VALUE_SAMPLER_CUBE  = 20,
  AK_VALUE_SAMPLER_RECT  = 21,
  AK_VALUE_SAMPLER_DEPTH = 22,
