...
typedef enum AkValueType {
  AK_VALUE_TYPE_UNKNOWN       =-1,
  AK_VALUE_TYPE_CUSTOM        = 0,
  ...
  AK_VALUE_TYPE_SAMPLER1D     = 17,
  AK_VALUE_TYPE_SAMPLER2D     = 18,
  AK_VALUE_TYPE_SAMPLER3D     = 19,
  AK_VALUE_TYPE_SAMPLER_CUBE  = 20,
  AK_VALUE_TYPE_SAMPLER_RECT  = 21,
  AK_VALUE_TYPE_SAMPLER_DEPTH = 22,

  AK_VALUE_TYPE_ENUM          = 23,
  AK_VALUE_TYPE_ARRAY         = 24
} AkValueType;
